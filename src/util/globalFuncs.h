...
inline Vec3b makeRainbow3B(float id)
{
    ...
    if(icP == 0)
    {
        return Vec3b(static_cast<unsigned char>(255.f * (1.f - ifP)), static_cast<unsigned char>(255.f * ifP),     0);
    }

    if(icP == 1)
    {
        return Vec3b(0, static_cast<unsigned char>(255.f * (1.f - ifP)), static_cast<unsigned char>(255.f * ifP));
    }

    if(icP == 2)
    {
        return Vec3b(static_cast<unsigned char>(255.f * ifP), 0, static_cast<unsigned char>(255.f * (1.f - ifP)));
    }
...
inline Vec3b makeJet3B(float id)
{
    ...
    if(icP == 3)
    {
        return Vec3b(static_cast<unsigned char>(255 * (1 - 0.5 * ifP)), 255, static_cast<unsigned char>(255 * (0.5 * ifP)));
    }

    if(icP == 4)
    {
        return Vec3b(static_cast<unsigned char>(255 * (0.5 - 0.5 * ifP)), 255, static_cast<unsigned char>(255 * (0.5 + 0.5 * ifP)));
    }
