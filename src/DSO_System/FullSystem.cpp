...
Vec4 FullSystem::trackNewCoarse(FrameHessian* fh)
{
    ...
    else
    {
        ...
        for(double rotDelta = 0.02; rotDelta < 0.05; rotDelta++)
        {
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       rotDelta, 0., 0.), Vec3(0., 0., 0.)));      // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1., 0.,
                                       rotDelta, 0.), Vec3(0., 0., 0.)));      // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1., 0., 0.,
            ...
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1., 0., 0.,
                                       -rotDelta), Vec3(0., 0., 0.)));     // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       rotDelta, rotDelta, 0.), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1., 0.,
                                       rotDelta, rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       rotDelta, 0., rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       -rotDelta, rotDelta, 0.), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1., 0.,
                                       -rotDelta, rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
            ...
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       -rotDelta, 0., -rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       -rotDelta, -rotDelta, -rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       -rotDelta, -rotDelta, rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
            lastF_2_fh_tries.push_back(fh_2_slast.inverse() * lastF_2_slast * SE3(Eigen::Quaterniond(1.,
                                       -rotDelta, rotDelta, -rotDelta), Vec3(0., 0., 0.))); // assume constant motion.
...
//              immature_notReady_skipped++;
            ...
            if((u > 0 && v > 0 && u < wG[1] && v < hG[1]))
            {
                ...
                float dist = coarseDistanceMap->fwdWarpedIDDistFinal[u + wG[1] * v] + (ptp[0] - floorf((float)(
                                 ptp[0])));
...
void FullSystem::printLogLine()
{
    ...
    LOG_INFO_IF(!setting_debugout_runquiet,
